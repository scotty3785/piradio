...
class TextStar:
    ...
    def write(self,data):
        ...
        if isinstance(data,str):
            self.port.write(bytearray(data,'ascii'))
        else:
    ...
    def MoveToLineStart(self,line):
        self.write(struct.pack('BBB',254,76,int(line)))
    ...
    def line1(self, text):
        self.MoveToLineStart(1)
        self.write(' '*16)
        self.MoveToLineStart(1)
        self.write(text[:16].center(16," "))
    def line2(self, text):
        self.MoveToLineStart(2)
        self.write(' '*16)
        self.MoveToLineStart(2)
        self.write(text[:16].center(16," "))
...
if __name__ == "__main__":
    ...
    for i in range(2):
        time.sleep(1)
        ts.line1("This is a long string")
        ts.line2("This is second line")
        time.sleep(1)
        ts.line1("Second String - 1")
        ts.line2("Second String - 2")
    #ts.CursorLeft()
